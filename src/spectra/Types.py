...
T_CTJ_PAIR = tuple[tuple[T_STR, T_STR, T_STR], tuple[T_STR, T_STR, T_STR]]
T_CTJ_PAIR_TABLE = tuple[T_CTJ_PAIR, ...]
T_IDX_PAIR_TABLE = tuple[tuple[T_INT, T_INT], ...]
...
T_E_COLLISIONAL_TRANSITION_SOURCE = T_LITERAL[
