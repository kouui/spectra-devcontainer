...
E_Rydberg_: T_FLOAT = 2.1798741 * 1.0e-11  #: Rydberg energy, infinite nuclear mass (:math:`R_\infty`), [:math:`erg`]
R_H_: T_FLOAT = 109678.758  #: H ionization wavenumber, measured (NIST/RH); cf. Bohr R_H = 109677.58, [:math:`cm^{-1}`]
E_Rydberg_H_: T_FLOAT = R_H_ * c_ * h_  #: H ionization energy = R_H_ * c_ * h_ (~13.5984 eV), [:math:`erg`]
