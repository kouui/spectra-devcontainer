...
class TestHpFfCrossSec:
    def test_scalar(self, ref):
        assert_close(
            ContinuumOpacity.Hp_ff_cross_sec_(7000.0, 5000e-8, 1e11),
            ref["COpac.Hp_ff_Te7000_w5000AA_Ne1e11"])


class TestH2pCrossSec:
    def test_scalar(self, ref):
        assert_close(
            ContinuumOpacity.H2p_cross_sec_(7000.0, 5000e-8, 1e10),
            ref["COpac.H2p_Te7000_w5000AA_Np1e10"])
